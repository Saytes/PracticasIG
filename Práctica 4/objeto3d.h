...
class Objeto3d{
    ...
    void generarNormalesCaras(std::vector<Cara> caras, std::vector<std::vector<GLfloat>> &normalCaras );
    //void generarNormalesCaras(std::vector<Cara> caras, std::vector<std::vector<GLfloat>> &normalCaras );
	...
	protected:
        ...
        std::vector<std::vector<GLfloat>> normalCaras;    //Vector que contiene las normales de las caras
        std::vector<Vertice> normalVertices; //Vector que contiene las normales de los vértices
};
